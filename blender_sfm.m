...
%% load images
close all;
imageDir=strcat('Datasets/Blender datasets/archeira');
...
%% motion estimation
tic;
[vSet]=motion_estimation(intrinsics,images,"KAZE",200);
toc;
...
[xyzPoints, camPoses, reprojectionErrors,tracks]= ... 
    dense_constructor(intrinsics,images,"Eigen",vSet);
toc;

%% get extrinsics and transform pcl using it
load("Datasets/Blender datasets/archeira/extrinsics");
...
%% perform IDW
[X,Y,Z,pidw]=inverseDistanceWeighting(p);
%% perform ICP
